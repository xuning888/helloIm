...
public final class DubboMessageServiceTriple {
    ...
    static {
        org.apache.dubbo.rpc.protocol.tri.service.SchemaDescriptorRegistry.addSchemaDescriptor(SERVICE_NAME, Msg.getDescriptor());
    ...
    com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest.class, com.github.xuning888.helloim.message.api.Msg.ChatMessageList.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest::parseFrom,
    com.github.xuning888.helloim.message.api.Msg.ChatMessageList::parseFrom);

    private static final StubMethodDescriptor pullOfflineMsgAsyncMethod = new StubMethodDescriptor("PullOfflineMsg",
    com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest.class, java.util.concurrent.CompletableFuture.class, MethodDescriptor.RpcType.UNARY,
    obj -> ((Message) obj).toByteArray(), obj -> ((Message) obj).toByteArray(), com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest::parseFrom,
    com.github.xuning888.helloim.message.api.Msg.ChatMessageList::parseFrom);
    ...
    public static class MessageServiceStub implements MessageService, Destroyable {
        ...
        public CompletableFuture<com.github.xuning888.helloim.message.api.Msg.ChatMessageList> pullOfflineMsgAsync(com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest request){
            return StubInvocationUtil.unaryCall(invoker, pullOfflineMsgAsyncMethod, request);
        }

        public void pullOfflineMsg(com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest request, StreamObserver<com.github.xuning888.helloim.message.api.Msg.ChatMessageList> responseObserver){
        ...
        public CompletableFuture<com.github.xuning888.helloim.message.api.Msg.ChatMessageList> getLatestOfflineMessagesAsync(com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest request){
            return StubInvocationUtil.unaryCall(invoker, getLatestOfflineMessagesAsyncMethod, request);
        }

        public void getLatestOfflineMessages(com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest request, StreamObserver<com.github.xuning888.helloim.message.api.Msg.ChatMessageList> responseObserver){
    ...
    public static abstract class MessageServiceImplBase implements MessageService, ServerService<MessageService> {
        ...
        public final Invoker<MessageService> getInvoker(URL url) {
            ...
            BiConsumer<com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest, StreamObserver<com.github.xuning888.helloim.message.api.Msg.ChatMessageList>> pullOfflineMsgFunc = this::pullOfflineMsg;
            handlers.put(pullOfflineMsgMethod.getMethodName(), new UnaryStubMethodHandler<>(pullOfflineMsgFunc));
            BiConsumer<com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest, StreamObserver<com.github.xuning888.helloim.message.api.Msg.ChatMessageList>> pullOfflineMsgAsyncFunc = syncToAsync(this::pullOfflineMsg);
            handlers.put(pullOfflineMsgProxyAsyncMethod.getMethodName(), new UnaryStubMethodHandler<>(pullOfflineMsgAsyncFunc));
            BiConsumer<com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest, StreamObserver<com.github.xuning888.helloim.message.api.Msg.ChatMessageList>> getLatestOfflineMessagesFunc = this::getLatestOfflineMessages;
            handlers.put(getLatestOfflineMessagesMethod.getMethodName(), new UnaryStubMethodHandler<>(getLatestOfflineMessagesFunc));
            BiConsumer<com.github.xuning888.helloim.message.api.Msg.PullOfflineMsgRequest, StreamObserver<com.github.xuning888.helloim.message.api.Msg.ChatMessageList>> getLatestOfflineMessagesAsyncFunc = syncToAsync(this::getLatestOfflineMessages);
